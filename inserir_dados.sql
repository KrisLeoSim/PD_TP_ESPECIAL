...
INSERT INTO public.carrinho(
	id_carrinho, id_utilizador, id_voo, valor_total, numero_lugares, data_compra, estado_carrinho, tipo_compra)
...
INSERT INTO public.feedback(
	id_feedback, id_utilizador, id_voo, classificacao_companhia, classificacao_destinos)
	VALUES (1, 1, 1, 18, 16);
...
INSERT INTO public.licitacoes(
	id_licitacao, id_utilizador, id_voo, valor, data, hora, estado_licitacao)
...
INSERT INTO public.mensagens(
	id_mensagem, id_utilizador_remetente, username_destinatario, assunto, mensagem, data_mensagem, hora_mensagem)
	VALUES (1, 1, 'joao', 'assunto', 'mensagem é esta', '2018/08/09', 10);


-- INSERT TABELA movimentos
INSERT INTO public.movimentos(
	id_movimento, id_utilizador, id_carteira, descricao_movimento, data, hora)
