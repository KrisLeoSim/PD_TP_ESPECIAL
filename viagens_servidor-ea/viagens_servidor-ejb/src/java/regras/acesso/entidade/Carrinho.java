...
public class Carrinho implements Serializable {
    ...
    public Carrinho(Integer idCarrinho, double valorTotal, int numeroLugares, Date dataCompra, String estadoCarrinho, String tipoCompra) {
        this.idCarrinho = idCarrinho;
    ...
    public String toString() {
        return "regras.acesso.entidade.Carrinho[ idCarrinho=" + idCarrinho + " ]";
    }
