...
@NamedQueries({
    ...
    , @NamedQuery(name = "Licitacoes.findByIdUtilizador", query = "SELECT l FROM Licitacoes l WHERE l.idUtilizador = :idUtilizador")
...
public class Licitacoes implements Serializable {
    ...
    public Licitacoes(Integer idLicitacao, int idUtilizador, double valor, Date data, int hora, String estadoLicitacao) {
        this.idLicitacao = idLicitacao;
    ...
    public String toString() {
        return "entidade.Licitacoes[ idLicitacao=" + idLicitacao + " ]";
    }
