...
@NamedQueries({
    ...
    , @NamedQuery(name = "Mensagens.findByIdUtilizadorRemetente", query = "SELECT m FROM Mensagens m WHERE m.idUtilizadorRemetente = :idUtilizadorRemetente")
...
public class Mensagens implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "id_utilizador_remetente")
    ...
    public Mensagens(Integer idMensagem, int idUtilizadorRemetente, String usernameDestinatario, String assunto, String mensagem, Date dataMensagem, int horaMensagem) {
        this.idMensagem = idMensagem;
    ...
    public int getIdUtilizadorRemetente() {
        return idUtilizadorRemetente;
    }

    public void setIdUtilizadorRemetente(int idUtilizadorRemetente) {
        this.idUtilizadorRemetente = idUtilizadorRemetente;
    }
    ...
    public String toString() {
        return "entidade.Mensagens[ idMensagem=" + idMensagem + " ]";
    }
